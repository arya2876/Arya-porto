            ...
            <FadeIn direction="right">
              <Card className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <CatPawButton
                    type="submit"
                    className="w-full px-8 py-4 text-lg font-medium rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 text-white shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
