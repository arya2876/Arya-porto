...
/**
 * ScrollGradientParagraph Component
 * Paragraph text with gradient that reveals second color on scroll
 * 
 * @param {string} children - Text content
 * @param {string} className - Additional CSS classes
 * @param {string} scrollColor - Color revealed on scroll (default: primary color)
 */
const ScrollGradientParagraph = ({ 
  children, 
  className = '', 
  scrollColor = '#8B5CF6'
}) => {
...
export default ScrollGradientParagraph;
